...
//        this.trim = false;
    ...
    /**
     * @see Type#formatValueForRecord(IFieldDetail, String)
    ...
    /**
     * @see Type#getField(byte[], int, IFieldDetail)
     */
	...
	protected int getFieldEnd(int position, final IFieldDetail currField, final byte[] record) {
	        int ret = Math.min(position + currField.getLen() - 1, record.length);
...
//	        	}
    ...
    /**
     * @see Type#setField(byte[], int, IFieldDetail, Object)
     */
