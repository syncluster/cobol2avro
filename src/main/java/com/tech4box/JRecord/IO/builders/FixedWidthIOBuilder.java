...
import com.tech4box.JRecord.def.IO.builders.IDefineFixedFieldsByLength;
import com.tech4box.JRecord.def.IO.builders.IDefineFixedFieldsByPosition;
...
implements IFixed /*, IFixedWidthIOBuilder, IDefineFixedFieldsByPosition, IDefineFixedFieldsByLength*/ {
	...
	/**
	 * @see CblIOBuilderBase#checkOk(boolean)
	 * 
	...
	/**
	 * @see IDefineFixedFieldsByLength#endOfRecord()
	 */
	@Override
	...
	/**
	 *  @see IDefineFixedFieldsByPosition#endOfRecord(int)
	 */
	@Override
