...
package com.tech4box.JRecord.zTest.schema;
...
import com.tech4box.JRecord.External.Def.Cb2Xml;
...
import com.tech4box.JRecord.schema.ArrayElementChecks;
...
public class TstArrayChecks extends TestCase {
	...
	private static Item getArrayItem() {
		try {
			Document doc = Cb2Xml.convertToXMLDOM(
