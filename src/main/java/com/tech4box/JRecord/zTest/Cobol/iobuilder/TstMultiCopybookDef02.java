...
/**
 * Check that Multiple copybooks have loaded correctly (using redefine)
 * 
 * @author Bruce Martin
 *
 */
public class TstMultiCopybookDef02 extends TestCase  {
	
	private static final String RECORD_A_CBL = "RecordA.cbl";
	private static final String MULTI_RECORD_TEST_CBL = "MultiRecordTest02.cbl";
