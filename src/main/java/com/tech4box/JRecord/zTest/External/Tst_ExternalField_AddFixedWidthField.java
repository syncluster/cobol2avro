package com.tech4box.JRecord.zTest.External;
...
public class Tst_ExternalField_AddFixedWidthField extends TestCase {
	...
	public void testNoAdjust() throws IOException {
		...
		FieldAdjustmentOptions adj = FieldAdjustmentOptions.NO_ADJUSTMENT;
	...
	public void testLengthAdj() throws IOException {
		...
		FieldAdjustmentOptions adj = FieldAdjustmentOptions.ADJUST_BY_LENGTH;
	...
	public void testCalcAdj() throws IOException {
		...
		FieldAdjustmentOptions adj = FieldAdjustmentOptions.CALCULATE_ADJUSTMENT;
