 ...
 *
 */
public class TstRecordVbIOWriter extends TestCase {
    ...
    private final String futjitsuCopybookName = "RBIVCopy";
    ...
    throws IOException  {
        IO.writeAFile(LineIOProvider.getInstance().getLineWriter(Constants.IO_VB),
                name, bytes, details);
    }
