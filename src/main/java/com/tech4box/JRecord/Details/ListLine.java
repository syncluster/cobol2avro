...
import com.tech4box.JRecord.Common.XmlConstants;
...
public abstract class ListLine extends BaseLine {
	...
	/**
	 * @see AbstractLine#getData(int, int)
	 */
	...
	/**
	 * @see AbstractLine#getField(IFieldDetail)
	 */
	...
	/**
	 * @see AbstractLine#getField(int, int)
	 */
...
//        System.out.println();
	...
	/**
	 * @see AbstractLine#getField(String)
	 */
	...
	/**
	 * @see AbstractLine#getFieldBytes(int, int)
	 */
	...
	/**
	 * @see AbstractLine#getFieldHex(int, int)
	 */
	...
	/**
	 * @see AbstractLine#getFieldText(int, int)
	 */
	...
	/**
	 * @see AbstractLine#getPreferredLayoutIdx()
	 */
	@Override
	...
	/**
	 * @see AbstractLine#replace(byte[], int, int)
	 */
	...
	/**
	 * @see AbstractLine#setData(String)
	 */
	...
	/**
	 * @see AbstractLine#setField(IFieldDetail, Object)
	 */
	...
	/**
	 * @see AbstractLine#setField(int, int, Object)
	 */
...
//    		}
	...
	/**
	 * @see AbstractLine#setField(String, Object)
	 */
	...
	/**
	 * @see AbstractLine#setFieldHex(int, int, String)
	 */
	...
	/**
	 * @see AbstractLine#setFieldText(int, int, String)
	 */
	...
	/**
	 * @see AbstractLine#setWriteLayout(int)
	 */
